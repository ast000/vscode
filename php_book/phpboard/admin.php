    ...
    <td background="images/admin_r3_c1.jpg"><div id="mainRegion">
        ...
        <table width="90%" border="0" align="center" cellpadding="4" cellspacing="0">
          <tr valign="top">
            ...
            <td><span class="smalltext">[<?php echo $row_RecBoard["boardid"];?>]</span><span class="heading"> <?php echo $row_RecBoard["boardsubject"];?></span>
  ...
  <tr>
    <td><table align="left" border="0" cellpadding="0" cellspacing="0" width="700">
        <tr>
          ...
          <td align="right" valign="top" background="images/admin_botbg.jpg" class="trademark">© 2008 eHappy Studio All Rights Reserved. </td>
